...
class ColorPalette {
  ...
  static const Color homeBackgroundColor =
  ...
  static const Color red = Color(0xFFCD4A4A); // Red color
  ...
  static const Color lightBlue =
      Color(0xFF3A7AD9); // Lighter blue from the gradient
  static const Color greenGradient =
      Color(0xFF68E09D); // Gradient green close to primary
